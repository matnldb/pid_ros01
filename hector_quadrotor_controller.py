...
"""This python script is the equivalent to the 'src/hector_quadrotor_controller.cpp', so it executes the same tasks.
...
def main_function():
	rospy.init_node("hector_quadrotor_controller", anonymous=True) #Initialize the node. anonymous=True for multiple nodes
	global rate
